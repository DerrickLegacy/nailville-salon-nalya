<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
    <div class="px-5 pt-5">
        <header class="flex justify-between items-start mb-2">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Expense</h2>
            <!-- Menu button -->
        ...
        <div class="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-1">Expenses</div>
        <div class="flex items-start">
            <div class="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">
                {{ number_format($getTodaysExpense['today_expense'], 0) }}
            </div>

            @php
                $trend = $getTodaysExpense['trend'];
                $percentage = $getTodaysExpense['percentage_change'];
                $badgeClass = match ($trend) {
                    'decrease' => 'text-green-700 bg-green-500/20',
                    'increase' => 'text-red-700 bg-red-500/20',
