<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
    <div class="px-5 pt-5">
        <header class="flex justify-between items-start mb-2">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Net Cash</h2>
            <!-- Menu button -->
        ...
        <div class="flex items-start">
            <div class="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">
                {{ number_format($getTodaysNetIncome['today_net'], 0) }}
            </div>

            @php
                $trend = $getTodaysNetIncome['trend'];
                $percentage = $getTodaysNetIncome['percentage_change'];
