...
<div class="min-w-fit">
    ...
    <div id="sidebar"
        ...
        <nav class="flex-1 px-3 py-6 space-y-2">
            ...
            <!-- Transactions -->
            <div class="space-y-1">
                <button @click="openDropdown = (openDropdown === 'transactions' ? null : 'transactions')"
                        class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg transition-all duration-200
                ...
                <div x-show="openDropdown === 'transactions'" 
                    ...
                    <a href="{{ route('transactions.income') }}" 
                       class="block px-3 py-2 text-sm rounded-lg transition-colors
                              {{ Request::is('transactions/income*') ? 'text-violet-600 dark:text-violet-400 bg-violet-50 dark:bg-violet-900/20' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-700/50' }}">
                        Income
                    </a>
                    <a href="{{ route('transactions.expense') }}" 
                       class="block px-3 py-2 text-sm rounded-lg transition-colors
                              {{ Request::is('transactions/expense*') ? 'text-violet-600 dark:text-violet-400 bg-violet-50 dark:bg-violet-900/20' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-700/50' }}">
                        Expenses
                    </a>
                </div>
            </div>
            ...
            <div class="space-y-1">
                ...
                <div x-show="openDropdown === 'reports'" 
                    ...
                    <a href="{{ route('reports.net.income') }}" 
                       class="block px-3 py-2 text-sm rounded-lg transition-colors text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        Net Income
                    </a>
                </div>
            ...
            <!-- Settings -->
            <div class="space-y-1">
                <button @click="openDropdown = (openDropdown === 'settings' ? null : 'settings')"
                        class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg transition-all duration-200
