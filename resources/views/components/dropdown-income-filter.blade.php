...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    @if ($showActions === 'false' || $filterPageCount === 'true' || $type === 'income' || $type === 'expense')
    <button
    ...
    <div class="origin-top-right z-10 absolute top-full left-0 right-auto min-w-56
        ...
        <ul class="mb-4">
            ...
            <li class="py-1 px-3">
                <label class="flex items-center">
                    <input type="checkbox" value="Bank" class="form-checkbox cash-type">
                    <span class="text-sm font-medium ml-2">Bank</span>
                </label>
            </li>
            <li class="py-1 px-3">
                <label class="flex items-center">
                    <input type="checkbox" value="Other" class="form-checkbox cash-type">
                    <span class="text-sm font-medium ml-2">Other</span>
                </label>
            </li>
            @endif
