...
<div x-data="{ searchOpen: false }">
    ...
    <div id="search-modal"
        ...
        <div class="bg-white dark:bg-gray-800 border border-transparent dark:border-gray-700/60 overflow-auto max-w-2xl w-full max-h-full rounded-lg shadow-lg"
            ...
            <!-- Search form -->
            <form class=" hidden border-b border-gray-200 dark:border-gray-700/60">
                <div class="relative">
            ...
            <div class="py-4 px-2">
                ...
                <div class="mb-3 last:mb-0">
                    <div class="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase px-2 mb-2">Recent
                        searches</div>
                    <ul class="text-sm">
                        <li>
                            <a class="flex items-center p-2 text-gray-800 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700/20 rounded-lg"
                                ...
                                <svg class="fill-current text-gray-400 dark:text-gray-500 shrink-0 mr-3" width="16"
